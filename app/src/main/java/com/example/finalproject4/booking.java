...
public class booking extends AppCompatActivity  {
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog popup = new DatePickerDialog(
                        booking.this, android.R.style.Theme_Holo_Light,
    ...
    private void storeData() {
        ...
        {
            Toast.makeText(booking.this, "Please fill the Input Field", Toast.LENGTH_LONG).show();
        }
        else if (inpJmlPenumpang.equals("5"))
        {
            Toast.makeText(booking.this, "Max 4 Passengers", Toast.LENGTH_LONG).show();
        }
        else
        {
            ...
            Toast.makeText(booking.this, "Input Success", Toast.LENGTH_LONG).show();

            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    final Intent mainIntent = new Intent(booking.this, BookingPage.class);
                    ...
                    booking.this.startActivity(mainIntent);
                    booking.this.finish();
                }
            }, 1500);
        }
